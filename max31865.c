...
static max31865_err_t max31865_bus_deinitialize(max31865_t const* max31865)
{
    return max31865->interface.bus_deinitialize
               ? max31865->interface.bus_deinitialize(max31865->interface.bus_user)
               : MAX31865_ERR_NULL;
}
...
max31865_err_t max31865_set_config_reg(max31865_t const* max31865, max31865_config_reg_t const* reg)
{
    ...
    return max31865_bus_write_data(max31865, MAX31865_REG_ADDRESS_CONFIG, &data, sizeof(data));
}
...
max31865_err_t max31865_get_config_reg(max31865_t const* max31865, max31865_config_reg_t* reg)
{
    ...
    max31865_err_t err =
        max31865_bus_read_data(max31865, MAX31865_REG_ADDRESS_CONFIG, &data, sizeof(data));
                                           ...
                                           max31865_high_fault_reg_t const* reg)
{
    ...
    return max31865_bus_write_data(max31865, MAX31865_REG_ADDRESS_HIGH_FAULT_H, data, sizeof(data));
}
                                           ...
                                           max31865_high_fault_reg_t* reg)
{
    ...
    max31865_err_t err =
        max31865_bus_read_data(max31865, MAX31865_REG_ADDRESS_HIGH_FAULT_H, data, sizeof(data));
                                          ...
                                          max31865_low_fault_reg_t const* reg)
{
    ...
    return max31865_bus_write_data(max31865, MAX31865_REG_ADDRESS_LOW_FAULT_H, data, sizeof(data));
}
...
max31865_err_t max31865_get_low_fault_reg(max31865_t const* max31865, max31865_low_fault_reg_t* reg)
{
    ...
    max31865_err_t err =
        max31865_bus_read_data(max31865, MAX31865_REG_ADDRESS_LOW_FAULT_H, data, sizeof(data));
...
max31865_err_t max31865_get_rtd_reg(max31865_t const* max31865, max31865_rtd_reg_t* reg)
{
    ...
    max31865_err_t err =
        max31865_bus_read_data(max31865, MAX31865_REG_ADDRESS_RTD_H, data, sizeof(data));
